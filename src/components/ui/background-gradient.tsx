  ...
  return (
    <div className={cn("relative p-[4px] group", containerClassName)}>
      <motion.div
        ...
        className={cn(
          "absolute inset-0 rounded-[20px] z-[1] opacity-60 group-hover:opacity-100 blur-xl transition duration-500 will-change-transform",
      ...
      <motion.div
        ...
        className={cn(
          "absolute inset-0 rounded-[20px] z-[1] will-change-transform",
